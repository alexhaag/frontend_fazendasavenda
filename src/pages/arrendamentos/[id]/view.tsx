...
export default function ArrendamentoView({ imovel }: ImovelProps) {

  return (
    <>
      <div className="container">
        <BotaoVoltar referencia={"/arrendamentos"} />
        <h1 className="titulo">Arrendamento - Código: {imovel?.codigo}</h1>
